  #include "player.h"
    ...
    Player::Player(string forename, string surname, int mobileNumber, string position, string skillrate){
    ...
    void Player::printPlayerInfo(){
        cout<<"Name:"<<forename<<" "<<surname<<", DOB: "<<dob<<", position:"<<position<<", contact:"<<mobileNumber<<"  Skill Rate (1 To 10): "<<skillrate<<endl;
    }
    void Player::setSkillrate(string skillrate){
    this->skillrate=skillrate;
    }
    string Player::getSkillrate(){
